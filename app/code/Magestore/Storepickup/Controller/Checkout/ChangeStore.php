...
class ChangeStore extends \Magento\Framework\App\Action\Action
{
    ...
    {
        $response = array('store_id' => $_POST['store_id'],'store_name'=>$_POST['store_name'],'store_address'=>$_POST['store_address']);
        $this->_checkoutSession->setData('storepickup_session',$response);
